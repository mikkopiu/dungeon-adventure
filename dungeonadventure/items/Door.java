...
public class Door extends Item implements Openable {
	...
	/**
	 * Constructor for default door, winOnOpen is false
	 */
	public Door() {
		this(false);
	}
	...
	/**
	 * Constructor for Door with possibility to set winOnOpen
	...
	/**
	 * Full constructor for Door with a name, description and winOnOpen
